...
import static net.minecraft.client.gui.screen.ScreenTexts.composeGenericOptionText;
...
public class ConfigScreen extends ConfigRawScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 77, this.height / 4 + 120 + -16, 150, 20, new TranslatableText("gui.back"), (button) -> {
            if (this.client != null) {
