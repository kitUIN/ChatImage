...
public class ChatImageClient implements ClientModInitializer {
    public final static String MOD_ID = "chatimage";
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(ChatImagePacket.DOWNLOAD_FILE_CHANNEL, (client, handler, buf, responseSender) -> ChatImagePacket.clientDownloadFileChannelReceived(buf));
        ClientPlayNetworking.registerGlobalReceiver(ChatImagePacket.GET_FILE_CHANNEL, (client, handler, buf, responseSender) -> ChatImagePacket.clientGetFileChannelReceived(buf));
    }
}
